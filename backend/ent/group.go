...
type Group struct {
	...
	// Required account capability level for this group: empty/free/plus/pro/team/k12.
	...
	// 是否允许该 OpenAI 分组使用管理员配置的实验性系统指令
	OpenaiExperimentalPromptEnabled bool `json:"openai_experimental_prompt_enabled,omitempty"`
	// ikik: custom /v1/models display list config (display only, no admission control)
	...
	// 高峰结束时间 HH:MM（不含），必须大于 peak_start；不支持跨天
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldVideoModelPrices, group.FieldModelPricing, group.FieldModelRouting, group.FieldSupportedModelScopes, group.FieldMessagesDispatchModelConfig, group.FieldModelAllowlist, group.FieldCodexModelsManifestConfig, group.FieldModelsListConfig, group.FieldReasoningEffortMappings:
			values[i] = new([]byte)
		case group.FieldIsExclusive, group.FieldIsSharedPool, group.FieldAllowImageGeneration, group.FieldImageRateIndependent, group.FieldAllowBatchImageGeneration, group.FieldVideoRateIndependent, group.FieldLongContextPricingEnabled, group.FieldClaudeCodeOnly, group.FieldModelRoutingEnabled, group.FieldMcpXMLInject, group.FieldAllowMessagesDispatch, group.FieldAllowLive, group.FieldForceOpenaiFast, group.FieldFreeOpenaiFast, group.FieldRequireOauthOnly, group.FieldRequirePrivacySet, group.FieldOpenaiExperimentalPromptEnabled, group.FieldProfitControlEnabled, group.FieldKiroCacheEmulationEnabled, group.FieldKiroAutoStickyEnabled, group.FieldPeakRateEnabled:
			values[i] = new(sql.NullBool)
		case group.FieldRateMultiplier, group.FieldDailyLimitUsd, group.FieldWeeklyLimitUsd, group.FieldMonthlyLimitUsd, group.FieldImageRateMultiplier, group.FieldImagePrice1k, group.FieldImagePrice2k, group.FieldImagePrice4k, group.FieldBatchImageDiscountMultiplier, group.FieldBatchImageHoldMultiplier, group.FieldVideoRateMultiplier, group.FieldVideoPrice480p, group.FieldVideoPrice720p, group.FieldVideoPrice1080p, group.FieldWebSearchPricePerCall, group.FieldSearchPricePer1k, group.FieldAudioRealtimePricePerMin, group.FieldAudioTtsPricePerMillionChars, group.FieldAudioSttPricePerHour, group.FieldProfitMinMargin, group.FieldProfitSafetyBuffer, group.FieldKiroCacheEmulationRatio, group.FieldPeakRateMultiplier:
			values[i] = new(sql.NullFloat64)
		case group.FieldID, group.FieldOwnerUserID, group.FieldDefaultValidityDays, group.FieldFallbackGroupID, group.FieldFallbackGroupIDOnInvalidRequest, group.FieldSortOrder, group.FieldRpmLimit, group.FieldKiroStickySessionTTLSeconds:
			values[i] = new(sql.NullInt64)
		case group.FieldName, group.FieldDescription, group.FieldStatus, group.FieldDuplicateOperationID, group.FieldScope, group.FieldPlatform, group.FieldRequiredAccountLevel, group.FieldSubscriptionType, group.FieldDefaultMappedModel, group.FieldMaxReasoningEffort, group.FieldMaxReasoningEffortOverLimit, group.FieldKiroEndpointMode, group.FieldPeakStart, group.FieldPeakEnd:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.FieldOpenaiExperimentalPromptEnabled:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field openai_experimental_prompt_enabled", values[i])
			} else if value.Valid {
				_m.OpenaiExperimentalPromptEnabled = value.Bool
			}
...
func (_m *Group) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("openai_experimental_prompt_enabled=")
	builder.WriteString(fmt.Sprintf("%v", _m.OpenaiExperimentalPromptEnabled))
	builder.WriteString(", ")
