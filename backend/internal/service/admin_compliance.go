...
const (
	AdminComplianceVersion        = "v2026.07.18"
	...
	AdminComplianceDocumentURLZH  = "https://github.com/wenyi401/ikik-api/blob/main/docs/legal/admin-compliance.zh.md"
	AdminComplianceDocumentURLEN  = "https://github.com/wenyi401/ikik-api/blob/main/docs/legal/admin-compliance.en.md"
	AdminComplianceAckPhraseZH    = "我已阅读、理解并同意 ikik-api 部署与运营合规承诺"
	AdminComplianceAckPhraseEN    = "I have read, understood, and agree to the ikik-api Deployment and Operation Compliance Commitment"
