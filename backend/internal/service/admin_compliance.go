...
const (
	...
	AdminComplianceDocumentURLZH  = "https://ikik-api/blob/main/docs/legal/admin-compliance.zh.md"
	AdminComplianceDocumentURLEN  = "https://ikik-api/blob/main/docs/legal/admin-compliance.en.md"
