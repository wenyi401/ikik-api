...
// Fixed cost-10 bcrypt hash used to keep missing-account login work comparable
// to the existing-account password path. The value is not secret.
...
// and applies promoCode only when a new OAuth user is created.
