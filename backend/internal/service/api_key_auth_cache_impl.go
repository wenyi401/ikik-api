...
const apiKeyAuthSnapshotVersion = 25 // v25: merge upstream v24 (model_allowlist enforcing semantics) + ikik extension fields
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	snapshot := &APIKeyAuthSnapshot{
		...
		OpenAIExperimentalPromptEnabled: apiKey.OpenAIExperimentalPromptEnabled,
		...
		User: APIKeyAuthUserSnapshot{
			...
			OpenAIExperimentalPromptUnlocked: apiKey.User.OpenAIExperimentalPromptUnlocked,
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			OpenAIExperimentalPromptEnabled: apiKey.Group.OpenAIExperimentalPromptEnabled,
	...
	attachAPIKeyGroupRoutesToAuthSnapshot(snapshot, apiKey)
	return snapshot
}
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	apiKey := &APIKey{
		...
		User: &User{
			...
			OpenAIExperimentalPromptUnlocked: snapshot.User.OpenAIExperimentalPromptUnlocked,
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			OpenAIExperimentalPromptEnabled: snapshot.Group.OpenAIExperimentalPromptEnabled,
	...
	attachAPIKeyGroupRoutesFromAuthSnapshot(apiKey, snapshot)
