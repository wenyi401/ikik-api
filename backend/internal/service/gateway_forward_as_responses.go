...
func firstResponsesClientToolMapping(mappings []apicompat.ResponsesClientToolMapping) apicompat.ResponsesClientToolMapping {
	if len(mappings) == 0 {
		return apicompat.ResponsesClientToolMapping{}
	}
	return mappings[0]
}
...
func (s *GatewayService) handleResponsesBufferedStreamingResponse(
	...
	clientToolMapping := firstResponsesClientToolMapping(clientToolMappings)
