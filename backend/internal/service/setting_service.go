...
func (s *SettingService) buildSystemSettingsUpdates(ctx context.Context, settings *SystemSettings) (map[string]string, error) {
	...
	updates[SettingKeyCarpoolBaseServiceFeeUSD] = formatNonNegativeSettingFloat(
		settings.CarpoolBaseServiceFeeUSD,
		CarpoolBaseServiceFeeUSDDefault,
	)
	updates[SettingKeyCarpoolSystemProxyFeeUSD] = formatNonNegativeSettingFloat(
		settings.CarpoolSystemProxyFeeUSD,
		CarpoolSystemProxyFeeUSDDefault,
	)
	updates[SettingKeyCarpoolRiskControlFeeUSD] = formatNonNegativeSettingFloat(
		settings.CarpoolRiskControlFeeUSD,
		CarpoolRiskControlFeeUSDDefault,
	)
...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		SettingKeyTablePageSizeOptions:                     "[10,20,50,100,1000]",
		SettingKeyCustomMenuItems:                          "[]",
		SettingKeyCustomEndpoints:                          defaultCustomEndpointsJSON,
