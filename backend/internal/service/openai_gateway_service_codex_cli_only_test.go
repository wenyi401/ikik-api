...
func TestLogOpenAIInstructionsRequiredDebug_LogsRequestDetails(t *testing.T) {
	...
	require.True(t, logSink.ContainsFieldValue("upstream_error_message", "Instructions are required"))
...
func TestOpenAIGatewayService_Forward_LogsInstructionsRequiredDetails(t *testing.T) {
	...
	require.True(t, logSink.ContainsFieldValue("upstream_error_message", "Missing required parameter: 'instructions'"))
