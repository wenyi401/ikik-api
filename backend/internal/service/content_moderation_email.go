...
func buildContentModerationViolationEmailBody(siteName string, log *ContentModerationLog, cfg *ContentModerationConfig) string {
	...
	statusBlock := ""
	if log.AutoBanned {
		statusBlock = `<div style="margin-top:24px;padding:18px 20px;border-radius:10px;background:#dc2626;color:#ffffff;font-size:18px;font-weight:700;text-align:center;line-height:1.6;">账户当前处于封禁状态，所有 API 请求将被拒绝</div>`
	}
    ...
    <div style="background:#ffffff;border:1px solid #e5e5e5;border-top:0;border-radius:0 0 8px 8px;padding:40px 48px;">
      ...
      <div style="background:#f7f7f8;border:1px solid #e5e5e5;border-radius:8px;padding:22px 28px;margin:28px 0;">
        ...
        <table style="width:100%%;border-collapse:collapse;font-size:16px;">
          ...
          <tr><td style="padding:12px 0;color:#6e6e80;border-bottom:1px solid #d9d9e3;">触发来源</td><td style="padding:12px 0;border-bottom:1px solid #d9d9e3;">内容审核</td></tr>
          <tr><td style="padding:12px 0;color:#6e6e80;border-bottom:1px solid #d9d9e3;">所属分组</td><td style="padding:12px 0;border-bottom:1px solid #d9d9e3;">%s</td></tr>
          <tr><td style="padding:12px 0;color:#6e6e80;border-bottom:1px solid #d9d9e3;">命中类别</td><td style="padding:12px 0;border-bottom:1px solid #d9d9e3;">%s / %.3f</td></tr>
          <tr><td style="padding:12px 0;color:#6e6e80;">累计触发次数</td><td style="padding:12px 0;color:#dc2626;font-weight:700;">%d 次（阈值 %d）</td></tr>
        </table>
      </div>
      %s
...
<body style="margin:0;padding:0;background:#f7f7f8;color:#202123;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif;">
  <div style="max-width:680px;margin:0 auto;padding:32px 20px;">
    ...
    <div style="background:#ffffff;border:1px solid #e5e5e5;border-top:0;border-radius:0 0 8px 8px;padding:40px 48px;">
      ...
      <div style="margin-top:24px;padding:18px 20px;border-radius:10px;background:#dc2626;color:#ffffff;font-size:18px;font-weight:700;text-align:center;line-height:1.6;">账户当前处于封禁状态，所有 API 请求将被拒绝</div>
      <p style="font-size:15px;line-height:1.8;color:#6e6e80;margin-top:24px;">如需申诉或恢复账号，请联系平台管理员处理。</p>
      <p style="font-size:14px;line-height:1.8;color:#6e6e80;margin-top:28px;">此邮件由 %s 自动发送，请勿回复。</p>
    </div>
  </div>
</body>
