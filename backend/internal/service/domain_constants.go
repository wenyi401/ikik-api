...
const (
	...
	// are exposed on the user-facing channel monitor page.
	...
	// SettingKeyPluginManagementEnabled controls sidebar visibility only; loaded
	// plugin runtimes remain unaffected by this presentation switch.
