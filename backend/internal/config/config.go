...
type GatewayConfig struct {
	...
	// DisableCodexIdentityEnforcement is the replacement for the legacy
	// originator-only switch. Both keys remain supported for compatibility.
	...
	// CNProviders: 国产 OpenAI 兼容供应商的余额检测配置。
