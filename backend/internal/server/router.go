...
func registerRoutes(
	...
	routes.RegisterIkikRoutes(v1, h, jwtAuth, adminAuth, auditLog, settingService)
	routes.RegisterDeveloperRoutes(r.Group("/api/developer/v1"), h, auditLog, settingService)
