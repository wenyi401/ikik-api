...
var auditBodyOmittedRoutes = map[string]struct{}{
	...
	"POST /api/v1/admin/prompt-audit/test":                             {},
	...
	"POST /api/v1/admin/prompt-audit/knowledge":                        {},
	"PUT /api/v1/admin/prompt-audit/knowledge/:id":                     {},
	"PUT /api/v1/admin/prompt-audit/knowledge/observations/:id/review": {},
}
