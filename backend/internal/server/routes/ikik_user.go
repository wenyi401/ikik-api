...
func registerIkikUserAccountRoutes(authenticated *gin.RouterGroup, h *handler.Handlers) {
	...
	accounts.GET("/:id/quota", h.UserAccount.QueryOpenAIQuota)
	accounts.GET("/:id/stats", h.UserAccount.GetStats)
	accounts.GET("/:id/today-stats", h.UserAccount.GetTodayStats)
	accounts.GET("/:id/ollama-cloud-usage", h.UserAccount.GetOllamaCloudUsage)
	accounts.PUT("/:id/ollama-cloud-usage/session", h.UserAccount.SaveOllamaCloudUsageSession)
	accounts.DELETE("/:id/ollama-cloud-usage/session", h.UserAccount.DeleteOllamaCloudUsageSession)
	accounts.PUT("/:id/ollama-cloud-usage/auto-refresh", h.UserAccount.SetOllamaCloudUsageAutoRefresh)
	accounts.POST("/:id/ollama-cloud-usage/refresh", h.UserAccount.RefreshOllamaCloudUsage)
	...
	accounts.POST("/:id/reset-quota", h.UserAccount.ResetOpenAIQuota)
