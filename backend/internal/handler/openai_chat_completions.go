...
func (h *OpenAIGatewayHandler) ChatCompletions(c *gin.Context) {
	...
	for {
		...
		h.recordCyberPolicyIfMarked(c, currentAPIKey, account, currentSubscription, reqModel, err != nil, cyberBlockBodyChat, channelMapping.ToUsageFields(reqModel, ""), service.HashUsageRequestPayload(body))
