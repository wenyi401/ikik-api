...
func (s *stubAdminService) CreateGroup(ctx context.Context, input *service.CreateGroupInput) (*service.Group, error) {
	...
	group := service.Group{ID: 200, Name: input.Name, Platform: input.Platform, RequiredAccountLevel: input.RequiredAccountLevel, Status: service.StatusActive}
	return &group, nil
}
...
func (s *stubAdminService) UpdateGroup(ctx context.Context, id int64, input *service.UpdateGroupInput) (*service.Group, error) {
	...
	if input.RequiredAccountLevel != nil {
		level = *input.RequiredAccountLevel
	}
	group := service.Group{ID: id, Name: input.Name, Platform: input.Platform, RequiredAccountLevel: level, Status: service.StatusActive}
	return &group, nil
}
...
func (s *stubAdminService) SetAccountError(ctx context.Context, id int64, errorMsg string) error {
	s.setAccountErrorCalls = append(s.setAccountErrorCalls, struct {
		accountID int64
		message   string
	}{accountID: id, message: errorMsg})
	return nil
}
