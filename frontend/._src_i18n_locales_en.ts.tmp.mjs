...
const __loc = {
  ...
  home: {
    ...
    console: {
      ...
      avgLatency: 'Avg. First Token',
      requestTrend: 'Request Trend',
      legendRequests: 'Requests',
      legendTokens: 'Tokens'
    },
    steps: {
      heading: 'Start in {steps} steps, migrate in {minutes} minutes',
      ariaLabel: 'Onboarding steps',
      register: {
        title: 'Create an account',
        desc: 'Sign up free and get trial credits instantly'
      },
      apiKey: {
        title: 'Get an API key',
        desc: 'Generate in one click, with multi-key management and access control'
      },
      baseUrl: {
        title: 'Replace the Base URL',
        desc: 'Point your client to us and finish migrating in minutes'
      }
    },
  ...
  nav: {
    ...
    tokenLeaderboard: 'Token Ranking',
    workspace: 'Workspace',
    userWorkspace: 'User',
  ...
  dashboard: {
    ...
    totalInviteIncome: 'Total Invite Income',
    shareIncome: 'Shared Income',
    totalShareIncome: 'Total Shared Income',
    apiKeys: 'API Keys',
    todayRequests: 'Today Requests',
    todayCost: 'Today Cost',
    todayTokens: 'Today Tokens',
  ...
  userAccounts: {
    ...
    importInvalidFile: 'Invalid import file: expected an account array or a ikik-api export with accounts.',
  ...
  carpool: {
    title: 'Carpool Pools',
    description: 'Pool owners can bring their own accounts, recruit members, review applications, and manually confirm payments. The system handles isolation, quota assignment, and routing.',
    createPool: 'Create Pool',
    myPools: 'My Pools',
    myOwnedPools: 'Owned Pools',
    joinedPools: 'Joined Pools',
    emptyOwned: 'You have not created any carpool pool yet.',
    emptyJoined: 'You have not joined any carpool pool yet.',
    emptyFiltered: 'No carpool pools match the current filters.',
    openDetail: 'View Details',
    collapseDetail: 'Collapse Details',
    totalPools: 'All Pools',
    searchPools: 'Search pools',
    searchPoolsPlaceholder: 'Search by pool name, group, platform, or invite code',
    filterStatus: 'Filter status',
    filterAllPools: 'All Pools',
    filterPending: 'Pending',
    paginationInfo: 'Showing {start}-{end} / {total}',
    previousPage: 'Previous',
    nextPage: 'Next',
    createDialogTitle: 'Create Carpool Pool',
    bindDialogTitle: 'Bind Pool Accounts',
    applyDialogTitle: 'Apply to Join Pool',
    detailDialogTitle: 'Carpool Pool Details',
    createSuccess: 'Carpool pool created',
    bindSuccess: 'Pool accounts bound',
    applySuccess: 'Application submitted',
    approveSuccess: 'Application approved',
    rejectSuccess: 'Application rejected',
    confirmPaidSuccess: 'Member activated',
    removeMemberSuccess: 'Member removed',
    deleteSuccess: 'Carpool pool deleted',
    loadFailed: 'Failed to load carpool pools',
    failedToCreate: 'Failed to create carpool pool',
    failedToBind: 'Failed to bind pool accounts',
    failedToApply: 'Failed to apply to pool',
    failedToApprove: 'Failed to approve application',
    failedToReject: 'Failed to reject application',
    failedToConfirmPaid: 'Failed to confirm payment',
    failedToRemoveMember: 'Failed to remove member',
    failedToDelete: 'Failed to delete carpool pool',
    failedToResolveInvite: 'Failed to resolve invite code',
    failedToSaveAllocation: 'Failed to save usage allocation',
    failedToResetLocalLimit: 'Failed to reset local limit state',
    allocationSaved: 'Usage allocation saved',
    resetLocalLimitSuccess: 'Local limit state reset',
    name: 'Pool Name',
    namePlaceholder: 'For example: OpenAI Prox20 5-seat pool',
    platform: 'Platform',
    ...
    extraFee: 'Extra Fee',
    defaultServiceFeeHint: 'Default platform service fee is {amount}, paid by the pool owner. System proxy and risk-control services are added on top.',
    ownerPaidServices: 'Owner-paid Services',
    ownerPaidServicesHint: 'These are platform services paid by the pool owner. They are not collected from members by the platform. Enabled services are included in the extra fee for owner-side pricing reference.',
    monthlyFee: '{amount}/mo',
    systemProxyService: 'System Proxy Service',
    systemProxyServiceDescription: 'When enabled, the platform configures system proxies for carpool accounts. It does not automatically take proxies from users’ private proxy pools.',
    riskControlService: 'Risk Control API Service',
    riskControlServiceDescription: 'Use the platform risk-control API to help detect abnormal usage.',
    extraFeeDescription: 'Extra Fee Note',
    extraFeeDescriptionPlaceholder: 'Generated from enabled services',
    selectedExtraFeeSummary: 'Current extra fee: {amount}',
    noExtraFeeSelected: 'No paid add-on service enabled',
    enabledServices: 'Enabled',
    noExtraServiceSelected: 'None',
    serviceStatus: 'Service Status',
    serviceEnabled: 'Enabled',
    serviceDisabled: 'Disabled',
    extraFeeDefaultService: 'Default platform service fee {amount}',
    extraFeeSystemProxy: 'System proxy service {amount}/month',
    extraFeeRiskControl: 'Risk Control API service {amount}/month',
    feeSummary: 'Pricing',
    quotaSummary: 'Quota Summary',
    notes: 'Notes',
    note: 'Application Note',
    notePlaceholder: 'Optional. Tell the owner about your usage or payment notes.',
    reviewNote: 'Review Note',
    reviewNotePlaceholder: 'Optional message for the applicant',
    owner: 'Owner',
    member: 'Member',
    removed: 'Removed',
    ...
    requestActivated: 'Activated',
    currentUserStatus: 'Status',
    join: 'Apply',
    joinByInvite: 'Join',
    inviteEntryTitle: 'Enter the invite code or link from the pool owner',
    joinByInviteHint: 'Paste an invite code or invite link from the pool owner. The system will detect it and open the application dialog.',
    inviteInputPlaceholder: 'Paste invite code or invite link',
    resolveInvite: 'Join',
    approve: 'Approve',
    reject: 'Reject',
    confirmPaid: 'Confirm Paid',
    removeMember: 'Remove Member',
    resetLocalLimit: 'Reset Local Limit',
    resetLocalLimitDialogTitle: 'Reset Carpool Account Local Limit',
    resetLocalLimitConfirm: 'Reset the local limit state for “{name}”? The system will first attribute all detected usage in the account’s current weekly window to the pool owner, then clear local rate-limit, error state, and scheduling cache. Confirm the account-side limit has recovered before continuing.',
    deletePool: 'Delete Pool',
    deleteDialogTitle: 'Delete Carpool Pool',
    deleteConfirm: 'Delete “{name}”? This closes the pool, revokes the carpool group and member subscriptions, and removes the bound accounts from the carpool group.',
    pendingApplications: 'Pending Applications',
    boundAccounts: 'Bound Accounts',
    bindAccounts: 'Bind Accounts',
    bindAccountsHint: 'After binding, these accounts move into the dedicated carpool subscription group, and detected 5-hour and weekly quotas are redistributed to members.',
    noAccountsBound: 'No accounts are bound to this pool yet.',
    noAccountsForPlatform: 'No personal accounts are available for this platform.',
    selectedAccounts: '{count} account(s) selected',
    fiveHourQuota: '5h Quota',
    weeklyQuota: 'Weekly Quota',
    totalFiveHourQuota: 'Total 5h Quota',
    totalWeeklyQuota: 'Total Weekly Quota',
    perMemberFiveHourQuota: 'Per-member 5h Quota',
    perMemberWeeklyQuota: 'Per-member Weekly Quota',
    fiveHourUsage: '5h Usage',
    weeklyUsage: 'Weekly Usage',
    editAllocation: 'Usage Allocation',
    allocationDialogTitle: 'Member Usage Allocation',
    allocationHint: 'Members are split equally by default. The owner can adjust shares based on offline agreements; both 5-hour and weekly limits follow the saved ratio.',
    allocationShare: 'Usage Share',
    allocationPercent: 'Allocation',
    allocationTotal: 'Current Total',
    allocationTotalInvalid: 'Member allocation must total 100%.',
    equalAllocation: 'Split Equally',
    ...
    group: 'Group',
    accountWindowUsage: 'Account 5h / Weekly Usage',
    accounts: 'Accounts',
    members: 'Members',
    myUsage: 'My Usage',
    joinRequests: 'Join Requests',
    noJoinRequests: 'There are no join requests right now.',
    totalRequests: 'Total Requests',
    totalTokens: 'Total Tokens',
    totalCost: 'Total Cost',
    last7dTokens: 'Last 7d Tokens',
  ...
  keys: {
    ...
    endpoints: {
      ...
      cardTitle: 'Available routes',
      cardDescription: 'After creating a key, copy any route below as the client Base URL. Routes are managed in system settings.',
      copied: 'Copied',
    ...
    useKeyModal: {
      ...
      endpointHint: 'Choose the endpoint used when generating the client configuration.',
  ...
  channelStatus: {
    ...
    quotaPool: {
      ...
      mineSubtitle: 'Summarizes quota and OpenAI OAuth window snapshots from accounts you own, grouped by pool.',
      platformTitle: 'Platform Shared Capacity Pool',
      platformSubtitle: 'Shows only public balance groups backed by platform accounts and approved public shares.',
  ...
  freeModels: {
    ...
    connectedSummaryWithFiltered: '{count} keys, {normal} normal, {limited} limited, {error} errors, {filtered} models disabled',
    ...
    disabledModelHint: 'Unavailable models have been removed from scheduling.',
    modelTestSummary: 'Model test done: {passed} passed, {disabled} disabled, {failed} failed',
    allModelsDisabled: 'All models are unavailable. Scheduling is disabled for this account.',
    noUsableModels: 'This account has no usable models.',
    ...
    health: {
      normal: 'Normal',
      limited: 'Limited',
      model_filtered: 'Models filtered',
      error: 'Error',
  ...
  modelMarket: {
    title: 'Model Market',
    kicker: 'Model Lobby',
    description: 'Browse accessible groups, channels, and pricing by model',
    ...
    moreChannels: '+ {count} channels',
    groupVisibility: {
      public: 'Shared group',
      private: 'Private / exclusive group'
    },
    detail: {
      pricing: 'Pricing',
    ...
    priceSummary: {
      input: 'In {price}/M',
      output: 'Out {price}/M',
      cacheRead: 'Cache {price}/M',
      perRequest: '{price}/request',
      imageOutput: 'Image {price}/request',
      tiered: 'Tiered: {summary}',
      varies: 'Pricing varies by channel',
      unknown: 'Unknown pricing mode'
    },
    categories: {
      all: 'All',
      openai: 'OpenAI',
    ...
    filters: {
      ...
      noActive: 'Showing all available models'
    },
    summary: {
      groups: '{count} groups',
      models: '{count} models',
      channels: '{count} channels',
      visibleModels: '{count} models visible',
      groupLabel: 'Groups',
      modelLabel: 'Models',
      channelLabel: 'Channels',
      pricingLabel: 'Pricing coverage'
    },
    columns: {
      model: 'Model',
  ...
  redeem: {
    title: 'Redeem Code',
    description: 'Enter your redeem code to add balance, points, or increase concurrency',
    ...
    codeRule2: 'Codes may add balance, points, increase concurrency, or grant trial access',
  ...
  profile: {
    ...
    preferPointsBillingHint: 'When enabled, model call costs consume points first, then balance for the remainder. Store payments are configured per product.',
    ...
    share: {
      ...
      imageDownloaded: 'Share image downloaded',
    ...
    activity: {
      ...
      days: '{count} days',
      mobileMeta: '{total} total · {streak} day streak',
      less: 'Less',
      more: 'More',
      cellTitle: '{date} used {tokens} tokens',
      loadFailed: 'Failed to load token activity',
      tooltip: {
        dayLabel: 'Daily Usage',
        weekLabel: 'Weekly Usage',
        totalLabel: 'Cumulative Usage',
        weekRange: '{start} - {end}',
        totalRange: 'Through {date}'
      },
      modes: {
        day: 'Daily',
        week: 'Weekly',
    ...
    receiptCode: {
      title: 'Receipt Code',
      description: 'Upload your Alipay or WeChat receipt QR code. Images are stored in object storage, not on the local server.',
      empty: 'No image',
  ...
  admin: {
    riskControl: {
      modeAdaptive: 'Adaptive Async',
      modeAdaptiveDesc: 'Forward requests immediately and audit them asynchronously using user risk and lifecycle stages',
      providerModelClassifier: 'Model Classifier',
      adaptive: {
        title: 'Adaptive async policy',
        summary: 'Audit new users fully, reduce sampling for stable users, and increase coverage for sustained risk',
        enforcementMode: 'Enforcement',
        shadow: 'Shadow',
        shadowDesc: 'Score and record only',
        notify: 'Notify',
        notifyDesc: 'Score and notify with cooldown',
        enforce: 'Enforce',
        enforceDesc: 'Disable the triggering key at critical risk',
        auditStages: 'Audit stages',
        fullAuditRequests: 'Full-audit requests',
        rampAuditRequests: 'Ramp end request',
        rampSampleRate: 'Ramp sample rate (%)',
        trustedSampleRate: 'Trusted sample rate (%)',
        watchSampleRate: 'Watch sample rate (%)',
        highRiskSampleRate: 'High-risk sample rate (%)',
        dailyDecay: 'Daily decay (%)',
        notificationCooldown: 'Notification cooldown (hours)',
        scoreWeights: 'Risk weights',
        scoreThresholds: 'Risk thresholds',
        low: 'Low',
        medium: 'Medium',
        severe: 'Severe',
        invalidAuditStages: 'The ramp end must not be lower than the full-audit request count',
        invalidThresholds: 'Watch, high-risk, and critical thresholds must increase in order'
      },
      riskLevels: {
        new: 'New',
        normal: 'Ramp',
      ...
      riskProfiles: {
        title: 'User risk',
        subtitle: 'Sampling follows observed request behavior',
        refresh: 'Refresh user risk',
        searchPlaceholder: 'Search email or user ID',
        allLevels: 'All levels',
        empty: 'No user risk profiles yet',
        user: 'User',
        level: 'Level / sample rate',
        auditProgress: 'Audit coverage',
        riskScore: 'Risk score',
        lastHit: 'Last hit',
        audited: 'Audited',
        sampleRate: 'Sample rate',
        manualAuto: 'Automatic',
        totalUsers: 'Users covered',
        totalAudited: 'Audited requests',
        needsAttention: 'Needs attention',
        averageScore: 'Average score',
        resetScore: 'Reset risk score',
        resetConfirm: 'Reset this user risk score to 0?',
        resetDone: 'Risk score reset',
      ...
      configHint: 'Use the configured content safety service to score request content and handle threshold hits by mode.',
      ...
      classifierPromptCustom: 'Custom',
      classifierPromptContract: 'Output fields and category values cannot be changed',
      classifierPromptRequired: 'The custom classifier policy cannot be empty',
      aliyunRegionId: 'Alibaba Cloud region',
      aliyunEndpoint: 'Alibaba Cloud endpoint',
      aliyunService: 'Alibaba Cloud service',
      aliyunServiceHint: 'Use query_security_check_pro where enabled in mainland regions, or query_security_check_cb for overseas/Singapore. Enter a Service that is enabled in the Alibaba Cloud console.',
      apiKey: 'Audit API credential',
      apiKeys: 'Audit API credentials',
      apiKeyCount: '{count} keys',
      apiKeyPlaceholder: 'Enter API Key',
      apiKeysPlaceholder: 'Add credentials, one per line. Use API Key for OpenAI or AccessKeyId:AccessKeySecret for Alibaba Cloud.',
      apiKeysPlaceholderReplace: 'Replace credentials, one per line. Stored credentials will be replaced on save.',
      apiKeysPlaceholderKeep: 'Add credentials, one per line. They will be appended on save.',
      apiKeysHint: '{count} credentials are currently stored. Use API Key for OpenAI or AccessKeyId:AccessKeySecret for Alibaba Cloud.',
      ...
      apiKeyTestNoInput: 'Enter audit API credentials to test first',
      apiKeyTestDone: 'Credential test completed for {count} keys',
      apiKeyTestFailed: 'Failed to test audit API credentials',
      ...
      auditTestHighest: 'Top raw category {category}, raw score {score}',
      auditTestComposite: 'Composite score',
      auditTestDispositionScore: 'Disposition score',
      auditTestObserveOnly: 'Observe only',
      ...
      riskThresholdsHint: 'Adjust hit thresholds by content safety category. Alibaba Cloud defaults only block explicit block/high-risk results.',
      riskThresholdDefault: 'Default {value}',
      riskThresholdReset: 'Restore defaults',
      riskThresholdPercent: 'Threshold percentage',
      groupPenalty: {
        title: 'Group Penalty',
        hint: 'When enabled, a selected category immediately penalizes the target groups once its independent score threshold is reached. Admin accounts are always exempt.',
        firstBlockHours: 'First block (hours)',
        secondBlockHours: 'Second block (hours)',
        thirdBlock: 'Third penalty',
        permanent: 'Permanent group block',
        targetGroups: 'Penalty target groups',
        targetGroupsHint: 'A rule hit blocks the user from these groups without affecting other groups.',
        searchGroups: 'Search group name, platform, or ID',
        categories: 'Penalty categories and thresholds',
        categoriesHint: 'Select categories to enforce; each category uses its own moderation score threshold.',
        hitThreshold: 'Penalty threshold',
        targetGroupsRequired: 'Select at least one target group when group penalties are enabled',
        categoriesRequired: 'Select at least one category when group penalties are enabled',
        invalidDurations: 'Durations must be whole hours from 1 to 8760, and the second cannot be shorter than the first',
        invalidThresholds: 'Each selected category threshold must be between 0% and 100%'
      },
      tabs: {
        adaptive: 'Adaptive',
        basic: 'Basic',
    ...
    revenue: {
      ...
      cards: {
        ...
        netCashMeta: 'Inflow {paid} / codes or admin {redeem} / refunds {refunds}',
        consumedRevenue: 'Consumed Revenue',
        consumedRevenueMeta: '{requests} requests / balance {balance} / points {points}',
      ...
      fields: {
        ...
        redeemBalancePaid: 'Code / Admin Revenue',
        subscriptionPaid: 'Subscription Paid',
        refundAmount: 'Refund Amount',
        pendingAmount: 'Pending Amount',
        paidOrders: 'Paid Orders',
        redeemBalanceCount: 'Code / Admin Count',
    ...
    backup: {
      ...
      description: 'Manage database backups, usage-log cleanup, and object storage for business assets',
      s3: {
      ...
      storage: {
        ...
        testConnection: 'Test Connection',
        storeFile: {
          title: 'Store File Card Object Storage',
          description: 'File-card uploads and downloads use this object storage. Downloads remain authorized by the backend.',
          enabled: 'Enable store file card object storage',
          maxSize: 'Single file limit {size}',
          saved: 'Store file card object storage saved',
          loadFailed: 'Failed to load store file card object storage',
          testSuccess: 'Store file card object storage connection succeeded'
        },
        receiptCode: {
          title: 'Receipt Code Object Storage',
          description: 'Withdrawal receipt code images from user profiles use this object storage.',
          enabled: 'Enable receipt code object storage',
          publicBaseUrl: 'Public Base URL',
          maxSize: 'Max Image Size (bytes)',
          presignExpire: 'Signed URL Expiry (seconds)',
          saved: 'Receipt code object storage saved',
          loadFailed: 'Failed to load receipt code object storage'
        }
      },
      schedule: {
      ...
      usageRetention: {
        ...
        description: 'Before deleting expired usage_logs details, the system creates aggregate snapshots and uploads a compressed archive to the S3 storage above.',
        enabled: 'Enable auto cleanup',
        retainDays: 'Detail retain days',
        retainDaysHint: 'For example, 3 keeps the latest 3 days of detail rows.',
        ...
        windowDaysHint: '1 means each run archives and deletes one expired day.',
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: 'Click "Create bucket", enter a name (e.g. ikik-api-backups), choose a region',
    ...
    users: {
      ...
      apiKeyGroupInactive: 'Inactive',
      apiKeyGroupPrivate: 'Private',
      ...
      countAsRevenue: 'Count as Revenue',
      countAsRevenueHint: 'Enabled by default for real payments. Abnormally large deposits over $10,000 are excluded from cash revenue statistics.',
    ...
    groups: {
      ...
      exclusiveRateSchedule: 'Exclusive Rate Schedule',
      addExclusiveRateSchedule: 'Add Exclusive Time Range',
      selectExclusiveUser: 'Exclusive User',
      exclusiveScheduleHint: "Exclusive schedules temporarily override this user's rate multiplier in the group, then restore the previous setting when the range ends.",
      noRateSchedules: 'No time range rate schedules configured',
      scheduleTarget: 'Target',
      groupDefaultTarget: 'Group Default',
      ...
      invalidTimeRange: 'End time must be later than start time; split overnight ranges into two rows',
    ...
    channelMonitor: {
      ...
      form: {
        ...
        jitterSecondsHint: 'Each check fires at interval ± a random offset within this value; 0 means fixed interval. Interval minus jitter must be at least 15s',
    ...
    accounts: {
      ...
      quotaDashboard: {
        ...
        accountMetaBasic: 'Total {total}, active {active}',
        ...
        quotaProtectedCount: 'Quota protected {count}',
      ...
      accountLevel: {
        ...
        userManualHint: 'Account level is detected automatically from account credentials.',
        manualHint: 'Admins can correct the OpenAI account level when automatic detection is missing or inaccurate.',
        unknown: 'Unknown',
        free: 'Free',
        plus: 'Plus',
        pro: 'Pro',
      ...
      credentialImportWarning: 'Official OAuth credentials are accepted by default. Enable Claude Web mode before importing Claude Web session files. API keys, URLs, and upstream endpoints are still rejected.',
      importClaudeWebMode: 'Parse as Claude Web',
      importClaudeWebModeHint: 'Import Claude Web JSON containing cookies, org_uuid, and account metadata',
      importClaudeWebFullCookie: 'Full browser cookie',
      importClaudeWebFullCookieHint: 'Enable only when importing a complete browser cookie',
      ...
      dataImportHint: 'Upload exported JSON/TXT/ZIP files, or paste download links to import accounts and proxies.',
      ...
      dataImportTargetGroupsHint: 'Optional. Selected groups must use one platform and imported accounts must match that platform.',
      dataImportGroupInactive: 'Inactive',
      dataImportCompatibilityMode: 'Compatibility mode',
      dataImportCompatibilityModeHint: 'For non-standard JSON/TXT files. The system extracts refresh_token, access_token, id_token, session_token, email, and account IDs, then imports them as OpenAI OAuth accounts.',
      ...
      dataImportZipFailed: 'Failed to parse ZIP file',
      dataImportZipNoImportableFiles: 'No importable JSON/TXT files were found in the ZIP',
      ...
      dataImportIgnoredFiles: 'Ignored {count} unsupported file(s)',
      ...
      revertProxyFallback: 'Revert Proxy',
      revertProxyFallbackSuccess: 'Account proxy reverted',
      revertProxyFallbackFailed: 'Failed to revert account proxy',
      proxyFallbackBadge: 'Fallback',
      proxyFallbackOrigin: 'Original proxy: {name}',
      resetStatus: 'Reset Status',
      ...
      custom: {
        protocol: 'Protocol',
        protocolHint: 'Custom accounts are routed only through matching endpoint protocols and matching native groups.',
        baseUrlHint: 'Required. Enter the upstream base URL, for example https://api.example.com/v1.',
        apiKeyHint: 'API Key for this custom upstream provider.',
        baseUrlRequired: 'Please enter Custom Base URL',
        protocolOptions: {
      ...
      openai: {
        ...
        codexImageToolDesc: 'Controls image_generation tools in Codex requests.',
        codexImageToolInherit: 'Follow channel',
        codexImageToolInheritDesc: 'Do not override channel or global policy.',
        codexImageToolForceInject: 'Force inject',
        codexImageToolForceInjectDesc: 'Add the image tool to Codex requests.',
        codexImageToolNoInject: 'Do not inject',
        codexImageToolNoInjectDesc: 'Do not add the image tool automatically.',
        codexImageToolBlockAll: 'Strip tool',
        codexImageToolBlockAllDesc: 'Remove client-provided image tools.',
      ...
      syncUpstreamModelsSuccess: 'Synced {count} upstream model(s)',
      syncUpstreamModelsEmpty: 'No upstream models returned',
      ...
      poolModeInfo: 'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another ikik-api instance.',
      ...
      poolModeRetryStatusCodesHint: 'Comma-separated HTTP status codes (100-599) that trigger same-account retry in pool mode. Leave blank to use defaults ({default}).',
      ...
      headerOverride: {
        ...
        hint: 'Override same-named request headers on forwarding',
        info: 'Applies to outbound requests of this account only. Auth headers and connection-control headers cannot be overridden.',
        ...
        bulkReplaceHint: 'Saving will replace existing header override configuration on selected accounts.',
        ...
        blockedName: 'This header cannot be overridden',
        duplicateName: 'Duplicate header name',
        invalidValue: 'Invalid header value',
        tooManyEntries: 'Too many header override entries'
      },
      ...
      quotaControl: {
        title: 'Quota Control',
        hint: 'Configure co session limits, client affinity and other scheduling controls.',
        windowCost: {
      ...
      networkSpeedSummary: 'TTFB {firstByte} · Total {total} · {speed}',
    ...
    proxies: {
      ...
      selectBackupProxy: 'Select backup proxy',
      fallbackNone: 'No fallback',
      fallbackDirect: 'Use direct connection',
      fallbackProxy: 'Use backup proxy',
      fallbackProxyTo: 'Backup: {name}',
      fallbackProxyRequired: 'Please select a backup proxy',
    ...
    usage: {
      ...
      tokenLeaderboardLimit: 'Rows',
      tokenLeaderboardRank: 'Rank',
      tokenLeaderboardUser: 'User',
      tokenLeaderboardTokens: 'Tokens',
      tokenLeaderboardRequests: 'Requests',
      tokenLeaderboardCost: 'Spend',
      tokenLeaderboardNoData: 'No ranking data',
      tokenLeaderboardLoadFailed: 'Failed to load ranking',
      cleanup: {
        button: 'Cleanup',
    ...
    ops: {
      ...
      diagnosis: {
        ...
        ttftHighAction: 'Optimize request processi reduce pre-processing time',
      ...
      alertRules: {
        ...
        metricDescriptions: {
          ...
          accountTempUnscheduledCount: 'Number of accounts currently temporarily unschedulable, such as automatic eviction after proxy or credential failures.',
    ...
    settings: {
      ...
      features: {
        ...
        carpool: {
          title: 'Carpool Pools',
          description: 'Allow users to create invite-only carpool pools, bind accounts, review members, and let the system allocate member quotas. Disabled by default.',
          configureLink: 'View and manage pools in Account Management > Carpool Pools',
          enabled: 'Enable Carpool Pools',
          enabledHint: 'When off, user and admin carpool entries are hidden, carpool endpoints are unavailable, and existing data is preserved.',
          baseServiceFee: 'Base service fee (USD)',
          systemProxyFee: 'System proxy fee (USD/mo)',
          riskControlFee: 'Risk-control fee (USD/mo)',
          feeHint: 'These fees are used to auto-calculate the owner-paid extra fee when creating a carpool pool. The platform still does not collect member carpool payments.'
        },
        riskControl: {
          title: 'Content Risk Control',
          description: 'Control content moderation, risk prompts, and unsafe input handling in one place.',
          configureLink: 'Open risk control settings',
          enabled: 'Enable Content Risk Control',
          enabledHint: 'When off, moderation rules no longer participate in request handling; saved rules are preserved.'
        },
        affiliate: {
          title: 'Invite Income',
          ...
          modal: {
            ...
            usageLimitLabel: 'Max Uses',
            usageLimitPlaceholder: 'Blank = unlimited',
            usageLimitHint: 'Counts successful signup bindings. Blank clears the limit.',
            expiresAtLabel: 'Expiry Time',
            expiresAtHint: 'The code cannot be used after this time. Blank means no expiry.',
            signupBonusLabel: 'Signup Balance Bonus',
            signupBonusPlaceholder: 'e.g. 5',
            signupBonusHint: 'Credited to new users who sign up with this code. Not counted as revenue.',
            autoGroupLabel: 'Auto-grant Group',
            noAutoGroup: 'Do not auto-grant',
            autoGroupHint: 'Automatically grants this standard group after signup.',
            ...
            errorBadUsageLimit: 'Max uses must be zero or a positive integer',
            errorBadExpiresAt: 'Invalid expiry time',
            errorBadSignupBonus: 'Signup bonus must be zero or positive',
            errorBadAutoGroup: 'Select a valid auto-grant group',
            errorEmpty: 'Select a user and set at least one custom rule'
          },
          batchModal: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for ikik-api end-user login',
      ...
      defaults: {
        ...
        affiliateRebateRateHint: 'Legacy recharge rebates are disabled. Configure consumption invite share in the revenue share policy.',
      ...
      autoModel: {
        ...
        description: 'Create custom virtual model names and let the system route each request to a small or stronger model by complexity.',
        enabled: 'Enable Auto',
        enabledHint: 'When enabled, /v1/models includes the enabled virtual model names below. Matching requests are rewritten to real models before existing channel, group, and account scheduling runs.',
        addRule: 'Add Auto Model',
        removeRule: 'Remove Auto Model',
        virtualName: 'Virtual Model Name',
        virtualNamePlaceholder: 'e.g. ikik-auto',
        ruleEnabled: 'Enabled',
        descriptionLabel: 'Description',
        descriptionPlaceholder: 'e.g. Mini for small jobs, GPT-5.5 for large work',
        allowedGroups: 'Allowed Groups',
        allowedGroupsHint: 'Only selected API key groups can use this virtual model. Select no groups to keep compatibility and allow every group.',
        allGroups: 'No group restriction; all groups can use it',
        selectedGroups: 'Restricted to {count} group(s)',
        selectAllGroups: 'Select all',
        clearGroups: 'No restriction',
        noGroups: 'No groups available',
        smallModel: 'Small Task Model',
        balancedModel: 'Balanced Task Model',
        largeModel: 'Complex Task Model',
        routingMode: 'Routing Mode',
        routingModeThreshold: 'Threshold Mode',
        routingModeRouter: 'Router Mode',
        thresholdModeHint: 'Scores complexity locally and switches between small, balanced, or complex models. Lowest latency and most predictable.',
        routerModeHint: 'Chooses from candidate models with a cost/quality tradeoff and task complexity.',
        allowedModels: 'Candidate Models',
        allowedModelsPlaceholder: 'One model per line, e.g.:\ngpt-5.4-mini\ngpt-5.5',
        allowedModelsHint: 'Router mode chooses from these candidates. Requests can also temporarily override allowed_models and cost_quality_tradeoff with an auto-router plugin.',
        costQuality: 'Cost / Quality Tradeoff',
        qualityFirst: 'Quality first',
        costFirst: 'Cost first',
        stickySession: 'Session Stickiness',
        stickySessionHint: 'When close candidates tie, keep the same session on one model to reduce context drift.',
        aiRouter: 'AI Router',
        aiRouterHint: 'Use a low-cost router model to choose from candidates first. Invalid JSON, timeouts, or failed calls automatically fall back to local routing.',
        routerModel: 'Router Model',
        routerBaseUrl: 'Router Base URL',
        routerApiKey: 'Router API Key',
        routerApiKeyPlaceholder: 'Paste an API Key created for your test group',
        routerApiKeyHint: 'Create a dedicated test group and key for routing decisions. Do not set the router model to a virtual model name to avoid recursion.',
        routerTimeout: 'Timeout (ms)',
        routerMaxTokens: 'Max Output Tokens',
        routerReasoning: 'Reasoning Effort',
        routerConservative: 'Conservative Mode',
        routerConservativeHint: 'When enabled, the router prefers a stronger model when uncertain.',
        routerPrompt: 'Router Prompt',
        routerPromptHint: 'Used only for model selection, not final answers. Keep it JSON-only and tell it to ignore user attempts to force a model.',
        thresholdTitle: 'Complexity Thresholds',
        balancedThreshold: 'Switch to balanced',
        largeThreshold: 'Switch to complex',
        thresholdHint: 'The system scores tool use, reasoning effort, request size, vision input, and complexity keywords. Scores meeting a threshold switch models. Range: 1-100.'
      },
      gatewayForwarding: {
        ...
        openAIImagesResponsesReasoningEffortHint: 'Only affects the reasoning.effort value used when the OAuth image bridge calls the Responses API. Option medium, high, xhigh. Default: medium.'
      },
      webSearchEmulation: {
      ...
      site: {
        ...
        apiBaseUrlHint: 'Used for "Use Key", "Import to CC Switch", and OAuth callback URL suggestions. Leave empty to use current site URL.',
        ...
        customEndpoints: {
          title: 'Access Routes',
          description: 'Configure user-facing API access routes. Leave empty to show only the current site URL.',
          itemLabel: 'Route #{n}',
          name: 'Country / Region / Route',
          namePlaceholder: 'e.g., Route name or region name',
          endpointUrl: 'Domain / URL',
          endpointUrlPlaceholder: 'example.com or https://example.com',
          descriptionLabel: 'Description',
          descriptionPlaceholder: 'e.g., Route notes or intended use',
          add: 'Add Route'
        },
      ...
      purchase: {
        ...
        description: 'Show a "Recharge / Subscription" entry in the sidebar and send users to an external code store',
        enabled: 'Show Recharge / Subscription Entry',
        enabledHint: 'When enabled, users can open a purchase jump page for buying redeem codes on an external card-code store.',
        url: 'External Code Store URL',
        urlPlaceholder: 'https://example.com',
        urlHint: 'Must be an absolute http(s) URL. Users open it in a n then return here to redeem the code.',
        invalidUrl: 'Enter a valid external code store URL',
        iframeWarning: 'iframe note: Some websites block embedding via X-Frame-Options or CSP (frame-ancestors). If the page is blank, provide an "Open in new tab" alternative.',
      ...
      payment: {
        ...
        receiptCodeOssTitle: 'Receipt Code Object Storage',
        receiptCodeOssHint: 'Stores user withdrawal receipt code images in data-management object storage.',
        receiptCodeOssEndpoint: 'Endpoint',
        receiptCodeOssRegion: 'Region',
      ...
      openaiFastPolicy: {
        ...
        actionForcePriority: 'Force priority',
        scope: 'Scope',
        scopeAll: 'All accounts',
        scopeOAuth: 'OAuth only',
        scopeAPIKey: 'API Key only',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: 'Welcome to ikik-api',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">ikik-api is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li><b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li><b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li><b>Key Distribution</b> - Generate independent API Keys for users</li><li><b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: 'Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of ikik-api, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>Each group can contain multiple upstream accounts</li><li>Each group has independent billing multiplier</li><li>Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: 'Welcome to ikik-api',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the ikik-api AI service platform.</p><p style="margin-bottom: 12px;"><b>Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>Create API Key</li><li>Copy key to your application</li><li>Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start',
        prevBtn: 'Skip'
      },
      keyManage: {
  ...
  payment: {
    ...
    externalPurchase: {
      kicker: 'External Code Store',
      title: 'Buy Redeem Codes',
      description: 'Purchases are handled by an independent card-code store. After payment, copy the redeem code from that site and return here to redeem it.',
      stepBuyTitle: 'Open the store',
      stepBuyDescription: 'Open the external code store in a n choose a plan, and complete payment there.',
      stepReceiveTitle: 'Receive the code',
      stepReceiveDescription: 'The store will show or send the redeem code after the order is complete. Keep it safe.',
      stepRedeemTitle: 'Redeem here',
      stepRedeemDescription: 'Return to the redeem page, enter the code, and the matching benefits will be issued automatically.',
      openStore: 'Open purchase page',
      redeemCode: 'I have a redeem code'
    },
    methods: {
      easypay: 'EasyPay',
      alipay: 'Alipay',
      ...
      redeem_code: 'Redeem Code Revenue',
    ...
    errors: {
      ...
      ORDER_PROCESSING: 'Order is still being processed. Please try again later.',
    ...
    admin: {
      ...
      todayOrders: 'Today Inflows',
      orderCount: 'Inflow Count',
      ...
      queryRefundSuccess: 'Refund status refreshed',
