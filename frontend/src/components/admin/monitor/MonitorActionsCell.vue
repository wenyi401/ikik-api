<template>
  <div class="flex items-center gap-1">
    ...
    <button
      ...
      :disabled="duplicating || row.api_key_decrypt_failed"
    ...
    >
      ...
      <span class="text-xs">{{ duplicating ? t('admin.channelMonitor.duplicating') : t('admin.channelMonitor.duplicate') }}</span>
    </button>
    <button
