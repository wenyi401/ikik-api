<template>
  ...
  >
    <form id="bulk-edit-account-form" class="space-y-5" @submit.prevent="() => handleSubmit()">
      ...
      <!-- OpenAI Compact mode -->
      <div v-if="!isUserScope && allOpenAIPassthroughCapable" class="border-t border-gray-200 pt-4 dark:border-dark-600">
        <div class="mb-3 flex items-center justify-between">
          <div class="flex-1 pr-4">
            <label
...
import type { Proxy as ProxyConfig, AdminGroup, AccountPlatform, AccountType, AccountLevel, GroupPlatform, OpenAICompactMode, OpenAIEndpointCapability, OpenAIResponsesMode } from '@/types'
...
// Upstream billing probing is available to API-key accounts on every platform.
