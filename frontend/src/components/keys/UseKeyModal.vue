  ...
  >
    <div class="space-y-4">
      ...
      <template v-else>
        ...
        <div v-if="showCodexAuthMode" class="rounded-lg border border-gray-200 p-3 dark:border-dark-700">
          <div class="mb-2">
          ...
          <div class="grid grid-cols-2 gap-1 rounded-lg bg-gray-100 p-1 dark:bg-dark-700" role="radiogroup">
            <button
              type="button"
              role="radio"
              data-testid="codex-auth-mode-legacy"
              :aria-checked="codexAuthMode === 'legacy'"
              :class="codexAuthMode === 'legacy' ? 'rounded-md bg-white px-3 py-2 text-sm font-medium text-primary-700 shadow-sm dark:bg-dark-800 dark:text-primary-300' : 'rounded-md px-3 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 dark:text-dark-300 dark:hover:text-white'"
            ...
            <button
              ...
              :class="codexAuthMode === 'api-key' ? 'rounded-md bg-white px-3 py-2 text-sm font-medium text-primary-700 shadow-sm dark:bg-dark-800 dark:text-primary-300' : 'rounded-md px-3 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 dark:text-dark-300 dark:hover:text-white'"
              @click="codexAuthMode = 'api-key'"
            >
              {{ t('keys.useKeyModal.openai.authModeApiKey') }}
            </button>
          </div>
          <div v-if="codexAuthMode === 'api-key'" data-testid="codex-api-key-restart-notice" class="mt-3 flex items-start gap-2 border-l-2 border-amber-400 bg-amber-50 px-3 py-2 text-xs leading-5 text-amber-800 dark:border-amber-500 dark:bg-amber-950/30 dark:text-amber-200">
