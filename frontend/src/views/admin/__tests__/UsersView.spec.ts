...
describe('admin UsersView', () => {
  ...
  it('clears the usage sort when switching to a last_used_at server sort', async () => {
    vi.useFakeTimers()
    ...
    // fork 的用量排序状态只持久化 metric/order（没有上游的 key 字段）
    expect(localStorage.getItem('admin-users-usage-sort')).toContain('"metric":"today"')
