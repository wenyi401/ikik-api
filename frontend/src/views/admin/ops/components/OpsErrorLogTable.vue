          ...
          <tbody class="divide-y divide-gray-100 dark:divide-dark-700">
            ...
            >
              ...
              <td class="px-4 py-2">
                ...
                <el-tooltip v-else-if="log.deleted_key_owner_user_id" :content="t('admin.ops.errorLog.userId') + ' ' + log.deleted_key_owner_user_id" placement="top" :show-after="500">
                  <span class="max-w-[120px] truncate text-xs font-medium text-gray-900 dark:text-gray-200">
                    {{ log.deleted_key_owner_email || '#' + log.deleted_key_owner_user_id }}
                  </span>
                </el-tooltip>
                <span v-else class="text-xs text-gray-400">-</span>
              </td>
              ...
              <!-- API Key -->
              <td class="px-4 py-2">
                <div v-if="log.api_key_id || log.api_key_name" class="flex max-w-[120px] items-center gap-1 text-xs">
                  <span class="truncate font-medium text-gray-900 dark:text-gray-200">
                    {{ log.api_key_name || '#' + log.api_key_id }}
                  </span>
                  <span
                    v-if="log.api_key_deleted"
                    class="inline-flex flex-shrink-0 items-center rounded bg-rose-100 px-1 py-px text-[10px] font-medium text-rose-600 ring-1 ring-inset ring-rose-200 dark:bg-rose-500/20 dark:text-rose-400 dark:ring-rose-500/30"
