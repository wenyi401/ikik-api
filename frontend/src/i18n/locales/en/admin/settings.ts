export default {
    settings: {
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for ikik-api end-user login',
      ...
      upstreamBillingProbe: {
        ...
        description: 'Periodically retrieve billing rates declared by upstream compatible gateway sites connected to OpenAI API keys.',
      ...
      gatewayForwarding: {
        ...
        openaiCodexClientVersionHint: 'The Codex client version declared upstream. The User-Agent and version header use the same version. Leave empty to use the auto-synced latest stable release; setting a value pins it.',
        openaiCodexVersionAutoSync: 'Auto-sync Codex version',
        openaiCodexVersionAutoSyncHint: 'Fetches the latest stable client version from the official repository every 6 hours. When disabled, only the pinned or built-in version is used.',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on ikik-api orders; the upstream type is sent as EasyPay type.',
