export default {
    accounts: {
      ...
      status: {
        ...
        proxyExpired: 'Proxy Expired',
        proxyUnavailable: 'Proxy Unavailable',
        proxyExpiredHint: 'Bound proxy "{name}" has expired. Scheduling resumes automatically after renewal or replacement',
        proxyUnavailableHint: 'Bound proxy "{name}" is unavailable. Scheduling resumes automatically after it is enabled or replaced',
      ...
      usageWindowsHint: '"5h / 7d" are the upstream account\'s official rolling usage windows (e.g. OpenAI ChatGPT, Claude). They are imposed by the upstream provider on the account itself — not configured by ikik-api, and unrelated to the models you map. Usage resets automatically once each window rolls over, and the limit cannot be lifted from within ikik-api.',
      ollamaCloud: {
      ...
      upstreamBilling: {
        trustWarning: 'This rate is declared by the upstream site for the current API key. ikik-api cannot verify that it matches actual charges. The upstream site or an intermediary may return forged, stale, or modified data. Verify it against bills, balance changes, and actual usage.',
      ...
      openaiQuotaReset: {
        ...
        runtimeStateWarning: 'The upstream quota was reset, but local runtime state cleanup failed. Do not consume another reset credit.',
