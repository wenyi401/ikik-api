...
export default {
  ...
  admin: {
    ...
    settings: {
      ...
      purchase: {
        ...
        urlHint: 'Must be an absolute http(s) URL. Users open it in a new window, then return here to redeem the code.',
  ...
  payment: {
    ...
    externalPurchase: {
      ...
      stepBuyDescription: 'Open the external code store in a new window, choose a plan, and complete payment there.',
