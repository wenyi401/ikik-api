export default {
    settings: {
      ...
      dingtalk: {
        title: '钉钉登录',
        description: '配置钉钉 OAuth，用于 ikik-api 用户登录',
      ...
      upstreamBillingProbe: {
        title: '上游倍率自动探测',
        description: '定期获取 OpenAI API Key 所连接上游兼容网关站点声明的计费倍率。',
        enabled: '启用全局自动探测',
      ...
      gatewayForwarding: {
        ...
        openaiCodexClientVersionHint: '网关对上游声明的 Codex 客户端版本号，User-Agent 与版本头使用同一版本。留空表示使用自动同步到的官方最新稳定版；填写后固定为该版本。',
        openaiCodexVersionAutoSync: '自动同步 Codex 版本号',
        openaiCodexVersionAutoSyncHint: '每 6 小时从官方仓库获取最新稳定版客户端版本号，无需为了跟版本而升级服务。关闭后仅使用手填版本或内置版本。',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: '添加当前易支付服务商额外支持的支付方式。支付方式会记录到 ikik-api 订单中，上游 type 会作为易支付 type 参数提交。',
