...
services:
  ikik-api:
    image: wenyi401/ikik-api:latest
    ports:
      - "8080:8080"
    environment:
...
- [GitHub Repository](https://github.com/wenyi401/ikik-api)
- [Documentation](https://github.com/wenyi401/ikik-api#readme)
